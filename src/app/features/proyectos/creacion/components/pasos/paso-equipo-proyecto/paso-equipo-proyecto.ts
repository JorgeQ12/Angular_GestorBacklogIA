...
/** Integra Equipo y su sincronización de Azure con el recorrido de creación. */
@Component({
  ...
  styleUrl: './paso-equipo-proyecto.css',
})
export class PasoEquipoProyecto {
  ...
  public constructor() {
    effect(() => {
      ...
      if (this.proyectoAnterior !== proyectoId) {
        ...
        this.origenActualizado.set(null);
        this.equipoActualizado.set(null);
        this.progresoEditado.set(null);
        this.sincronizacionInicialSolicitada = false;
      }
  ...
  /** Guarda Equipo antes de continuar. */
