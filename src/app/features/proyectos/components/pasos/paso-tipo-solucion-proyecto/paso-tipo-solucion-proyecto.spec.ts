...
describe('PasoTipoSolucionProyecto', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({ imports: [PasoTipoSolucionProyecto] }).compileComponents();
  ...
  it('compone la tarjeta y el formulario de Tipo de solución', () => {
    ...
    expect(fixture.nativeElement.querySelector('app-formulario-tipo-solucion-proyecto')).toBeTruthy();
  });
});
