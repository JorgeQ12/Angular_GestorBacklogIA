...
import {
  type DatosVinculacionAzure,
  type ResultadoVinculacionAzure,
} from '../../../models/vinculacion-azure-proyecto.model';
import { ModoFormularioProyecto } from '../../../models/modo-formulario-proyecto.model';
import { PasoVinculacionAzureProyecto } from './paso-vinculacion-azure-proyecto';
...
describe('PasoVinculacionAzureProyecto', () => {
  let fixture: ComponentFixture<PasoVinculacionAzureProyecto>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [PasoVinculacionAzureProyecto],
    }).compileComponents();
    fixture = TestBed.createComponent(PasoVinculacionAzureProyecto);
  ...
  it('inicia con la captura sin presentar errores', () => {
    ...
    expect(obtenerElemento().querySelector('header')).toBeTruthy();
