...
describe('ConsultaProyectosService', () => {
  let servicio: ConsultaProyectosService;
  ...
  beforeEach(() => {
    ...
    servicio = TestBed.inject(ConsultaProyectosService);
...
function crearResultado(
  datos: PaginadoDto<ResumenProyectoDto>,
): ResultadoApi<PaginadoDto<ResumenProyectoDto>> {
  return {
    exitoso: true,
    tipo: 1,
    datos,
...
const PAGINA_DTO: PaginadoDto<ResumenProyectoDto> = {
  registros: [
    {
      id: 42,
