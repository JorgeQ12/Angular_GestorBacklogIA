...
export const TAMANO_PAGINA_PROYECTOS = 10;

/** Evita solicitudes por términos demasiado ambiguos. */
export const LONGITUD_MINIMA_BUSQUEDA_PROYECTOS = 3;

/** Evita una solicitud por cada pulsación mientras se escribe. */
export const ESPERA_BUSQUEDA_PROYECTOS_MILISEGUNDOS = 300;

/** Permite retirar el estado sin depender de una acción de limpieza separada. */
export const OPCIONES_FILTRO_ESTADO_PROYECTOS = [
